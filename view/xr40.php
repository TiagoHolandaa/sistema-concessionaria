...
<body>
    ...
    <div class="container">
        <div class="row gx-3 ">
            <div class="col-12 ">
                <div class=" ">
                    <img src="../img/car-volvo/xr40.webp" alt=" camisa6 " width="100% " class="m-3 ms-1 py-5 "></div>
            </div>
            <div class=" col m-0 ">
                <div class="p-0 ">
                    <h6 class="card-title ">VOLVO SUV</h6>
                    <p class="card-text " style="font-size: 40px; ">XR40 Recharge <span class="span "> 100% elétrico</span></p>
                    <p class="card-text p " style="font-size: 50px; ">A partir R$ 409.950</p>
                    <br><br>
                    <center>
                        <div>
