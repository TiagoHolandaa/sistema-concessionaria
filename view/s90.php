    ...
    <div class="container-fluid">
        <div class="row gx-3 ">
            <div class="col-12 ">
                    ...
                    <img src="../img/car-volvo/s90.webp" alt="camisa6 " width="100%" class="m-3 ms-1 py-5"></div>
            
            <div class=" col m-0">
                <div class="p-0">
                    <h6 class="card-title">SEDAN</h6>
                    <p class="card-text " style="font-size: 40px;">SC90 Recharge <span class="span "> Híbrido Plug-in</span></p>
