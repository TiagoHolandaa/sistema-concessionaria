...
<head>
    ...
    <style>
        ...
        * {
        ...
        .icon-pes{
            background: url(../img/galeria/bx-search.svg);
        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-white my-navbar">
            ...
            <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarsExample07">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark mx-0 border-0 shadow" aria-labelledby="dropdownUser2" style="width: 220px;">
                                ...
                                <img src="../img/car-volvo/volvo-icon.svg" width="25px" alt="">
                                    Volvo
                                </a>
                                </li>
                                <li>
                                <a class="dropdown-item d-flex gap-2 align-items-center" href="renault.php">
                                <img src="../img/car-renault/renault-icon.svg" class="mx-1" width="15px" alt="">
                                    Renault
                                </a>
                                </li>
                                </li>
                    ...
                    <form>
                        <input class="form-control btn-secondary btn btn-pesquisa icon-pes bg-light link-dark text-start rounded-pill" type="text" placeholder="Pesquisar" aria-label="Pesquisar" style="border: 0.5px solid #adb5bd;">
