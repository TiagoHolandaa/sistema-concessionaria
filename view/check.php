                    ...
                    <form class="needs-validation" novalidate method="POST">
                        <div class="row g-3">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="nome" id="firstName" placeholder="" value="<?php echo($_SESSION["nome"])?>" required>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="sobrenome" id="lastName" placeholder="" value="<?php echo($_SESSION["sobrenome"])?>" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="text" class="form-control" name="cpf" id="username" placeholder="Username" value="<?php echo($_SESSION["cpf"])?>" required>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="text" class="form-control" name="uf" id="uf" placeholder="uf" value="<?php echo($_SESSION["uf"])?>" required>
                                    <div class="invalid-feedback">
                                        Seu nome de usuário é obrigatório.
                                    </div>
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="text" class="form-control" name="cidade" value="<?php echo($_SESSION["cidade"])?>" id="username" placeholder="Cidade" required>
                                    <div class="invalid-feedback">
                                        Seu nome de usuário é obrigatório.
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="bairro" class="form-control" id="address" value="<?php echo($_SESSION["bairro"])?>" placeholder="1234 Main St" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" value="<?php echo($_SESSION["rua"])?>" name="rua" class="form-control" id="address2" placeholder="Apartment or suite">
                            </div>

                            <div class="col-md-5">
                                <label for="country" class="form-label">Número</label>
                                <input type="text" class="form-control" name="numero" id="zip" placeholder="" value="<?php echo($_SESSION["nm"])?>" required>
                                <div class="invalid-feedback">
                                    CEP obrigatório
                                </div>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" value="<?php echo($_SESSION["complemento"])?>" class="form-control" name="complemento" id="zip" placeholder="" required>
                                <div class="invalid-feedback">
                                    CEP obrigatório
                                </div>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" value="<?php echo($_SESSION["cep"])?>" class="form-control" name="cep" id="zip" placeholder="" required>
                                <div class="invalid-feedback">
                                    CEP obrigatório
                                </div>
                            </div>
