                ...
                <section class="form">
                    <div class="container px-0">
                        <div class="box">
                            <div class="row">
                                <main class="form-signin">
                                    <form method="POST" action="../controller/login-con.php">
                                      ...
                                      <button class="w-100 btn btn-lg btn-dark mb-2" name="submit" type="submit">Entrar</button>
